...
This catalog is optional and can be placed along `Cyberware.toml` or by its own section in the manifest.
...
[02_module_layout_and_sdk_pattern.md](https://github.com/cyberfabric/cyberware-rust/blob/main/docs/modkit_unified_system/02_module_layout_and_sdk_pattern.md).
