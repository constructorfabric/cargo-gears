...
impl GenerateArgs {
    pub fn run(self) -> anyhow::Result<()> {
        cyberware_cli_core::generate::GenerateArgs::from(self).run()
    }
}

impl From<GenerateArgs> for cyberware_cli_core::generate::GenerateArgs {
...
impl WorkspaceArgs {
    pub fn run(self) -> anyhow::Result<()> {
        cyberware_cli_core::generate::workspace::WorkspaceArgs::from(self).run()
    }
}

impl From<WorkspaceArgs> for cyberware_cli_core::generate::workspace::WorkspaceArgs {
...
impl ModuleArgs {
    pub fn run(self) -> anyhow::Result<()> {
        cyberware_cli_core::generate::module::ModuleArgs::from(self).run()
    }
}

impl From<ModuleArgs> for cyberware_cli_core::generate::module::ModuleArgs {
...
impl GenerateConfigArgs {
    pub fn run(self) -> anyhow::Result<()> {
        cyberware_cli_core::generate::config::GenerateConfigArgs::from(self).run()
    }
}

impl From<GenerateConfigArgs> for cyberware_cli_core::generate::config::GenerateConfigArgs {
...
pub enum GenerateCommand {
    /// Generate a new Cyberware workspace
...
impl From<GenerateCommand> for cyberware_cli_core::generate::GenerateCommand {
